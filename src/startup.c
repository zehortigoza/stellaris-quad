...
__attribute__ ((section(".isr_vector")))void (* const g_pfnVectors[])(void) =
{
    ...
    gpioa_mpu6050_interruption,             // GPIO Port A
    IntDefaultHandler,                      // GPIO Port B
    IntDefaultHandler,                      // GPIO Port C
    IntDefaultHandler,                      // GPIO Port D
    IntDefaultHandler,                      // GPIO Port E
    IntDefaultHandler,                      // UART0 Rx and Tx
    uart1_radio_interruption,               // UART1 Rx and Tx
    ...
    timer0_motors_interruption,             // Timer 0 subtimer A
    IntDefaultHandler,                      // Timer 0 subtimer B
    timer1_500ms_interruption,              // Timer 1 subtimer A
    ...
    i2c1_mpu6050_interruption,              // I2C1 Master and Slave
