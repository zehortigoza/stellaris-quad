...
void agent_init(void)
{
    ...
    pid_init(&pid_roll, configuration.p_gaing, configuration.i_gaing, 0, 300, (1.0/COMMAND_FREQUENCY));
    pid_init(&pid_pitch, configuration.p_gaing, configuration.i_gaing, 0, 300, (1.0/COMMAND_FREQUENCY));
