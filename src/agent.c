...
void agent_init(void)
{
    ...
    pid_init(&pid_roll, configuration.p_gaing, configuration.i_gaing, 0, 100, (1.0/COMMAND_FREQUENCY), 'r');
    pid_init(&pid_pitch, configuration.p_gaing, configuration.i_gaing, 0, 100, (1.0/COMMAND_FREQUENCY), 'p');
